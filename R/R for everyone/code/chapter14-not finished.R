...
trophies2 <- data.frame(sport=c('basketball', 'golf'),league=c('nba', 'pga'),trophy=c('larry o brien campionshio tropgy','wanamaker trophy'),stringsAsFactors = FALSE)
...
#14.2 Joins
download.file(url='http://jaredlander.com/data/US_Foreign_Aid.zip',destfile = 'data/ForeinAid.zip')
